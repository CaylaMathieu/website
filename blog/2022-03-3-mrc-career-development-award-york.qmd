---
title-block-banner: ../../assets/img/york1803a.jpg
format:
  html:
    include-in-header:
      text: |
        ...
        .quarto-title-block .quarto-title-banner {
          height: 250px;             /* Change banner thickness */
          background-size: cover;    /* Forces image to scale nicely */
          background-position: center; /* Keeps center of image focused */
        }
        </style>
...
slug: condensate
page-layout: article
image: ../../assets/img/ukri-mrc-square-logo.png
---
